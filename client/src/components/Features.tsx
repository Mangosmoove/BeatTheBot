  ...
  return ( 
    <section className="mt-18"> 
      <div className="mb-8 text-center"> 
        ...
        <h2 className="mt-2 text-2xl font-bold text-foreground">Your resume, under the microscope.</h2>
        <p className="mx-auto mt-3 max-w-2xl text-sm text-muted-foreground">We analyze the same signals that can determine whether your resume gets parsed, matched, and surfaced by automated screening systems.</p> 
      </div> 
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4"> 
        {items.map((it) => ( 
          <div key={it.k} className="rounded-md border border-primary/60 bg-card/40 p-5 transition hover:border-primary hover:bg-primary/5"> 
